...
full article: https://refactoring.guru/design-patterns/abstract-factory
"""
...
3. Declare the abstract factory interface with a set of creation methods for 
all abstract products. 

4. Implement a set of concrete factory classes, one for each product variant.

5. Create factory initialization code somewhere in the app. It should 
instantiate one of the concrete factory classes, depending on the application 
...
def switch_case(input: str) -> None:
    switch = {
        "1": client_code(ConcreteFactory1()),
        "2": client_code(ConcreteFactory2()),
    }
